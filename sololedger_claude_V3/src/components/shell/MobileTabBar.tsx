...
export function MobileTabBar<T extends MobileTab>({
  ...
  return (
    <nav
      ...
      className="relative z-40 flex h-[calc(4rem+env(safe-area-inset-bottom))] shrink-0 items-stretch border-t border-hi/10 bg-surface/95 backdrop-blur-xl pb-[env(safe-area-inset-bottom)] lg:hidden"
    >
